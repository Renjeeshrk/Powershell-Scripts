...
Get-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\" -ErrorAction SilentlyContinue
if (!$?)
    {
    New-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\" -ItemType Directory
    }
 
# create a folder for every month
Get-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\$month\" -ErrorAction SilentlyContinue
if (!$?)
    {
    New-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\$month\" -ItemType Directory
    }
 
# create a folder for every day
Get-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\$month\$today\" -ErrorAction SilentlyContinue
if (!$?)
    {
    New-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\$month\$today\" -ItemType Directory
    }
 
# simple credential handling
$username = "hgcadmin"
$username1 = ""
$pwfile = "C:\Users\rm_rkidangayath\Desktop\RK\password.txt"
...
$switches_array = @()
$switches_array = Get-Content -Path "C:\Users\rm_rkidangayath\Desktop\RK\switches.txt"
 
foreach ($switch in $switches_array)
    {
    # create a folder for every device
    Get-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\$month\$today\$switch" -ErrorAction SilentlyContinue
    if (!$?)
        {
        New-Item "C:\Users\rm_rkidangayath\Desktop\RK\$year\$month\$today\$switch" -ItemType Directory
        }
